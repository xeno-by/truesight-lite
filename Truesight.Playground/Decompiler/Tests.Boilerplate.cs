            ...
            if (referenceFileName != null)
            {
                ...
                if (s_reference.IsEmpty())
                {
                    ...
                    Assert.Fail(String.Format(
                        "Reference decompilation result for the method '{1}' is empty.{0}" +
...
//                            "Comparing actual and expected decompilation results{0}{1}",
                        ...
                        Trace.WriteLine(String.Empty);
                        Assert.Fail("Decompilation result doesn't match reference result.");
                    }
                }
            }
            else
            {
                ...
                Assert.Fail(String.Format(
                    "Couldn't find a file in resource that contains reference decompilation result for the method '{1}'.{0}" +

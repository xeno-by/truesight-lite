...
{
    // ldloca.s, ldloca
    [global::Truesight.Parser.Impl.Ops.OpCodesAttribute(0x12, 0xfe0d)]
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public sealed class Ldloca : global::Truesight.Parser.Impl.ILOp
    {
        public override global::Truesight.Parser.Api.IILOpType OpType { get { return global::Truesight.Parser.Api.IILOpType.Ldloca; } }

        private readonly int? _constValue;
        private readonly bool _useConstValue;
        private readonly int _value;

        internal Ldloca(global::Truesight.Parser.Impl.MethodBody source, global::System.IO.BinaryReader reader)
        ...
        internal Ldloca(global::Truesight.Parser.Impl.MethodBody source, global::System.IO.BinaryReader reader, global::System.Collections.ObjectModel.ReadOnlyCollection<global::Truesight.Parser.Impl.ILOp> prefixes)
        ...
        private static global::System.Reflection.Emit.OpCode AssertSupportedOpCode(global::System.IO.BinaryReader reader)
        {
            ...
            // ldloca.s, ldloca
            global::XenoGears.Assertions.AssertionHelper.AssertTrue(global::System.Linq.Enumerable.Contains(new ushort[]{0x12, 0xfe0d}, (ushort)opcode.Value.Value));

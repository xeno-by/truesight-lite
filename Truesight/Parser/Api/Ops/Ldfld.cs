...
{
    // ldfld, ldsfld
    [global::Truesight.Parser.Impl.Ops.OpCodesAttribute(0x7b, 0x7e)]
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public sealed class Ldfld : global::Truesight.Parser.Impl.ILOp
    {
        public override global::Truesight.Parser.Api.IILOpType OpType { get { return global::Truesight.Parser.Api.IILOpType.Ldfld; } }

        private readonly int _fieldToken;

        internal Ldfld(global::Truesight.Parser.Impl.MethodBody source, global::System.IO.BinaryReader reader)
        ...
        private static global::System.Reflection.Emit.OpCode AssertSupportedOpCode(global::System.IO.BinaryReader reader)
        {
            ...
            // ldfld, ldsfld
            global::XenoGears.Assertions.AssertionHelper.AssertTrue(global::System.Linq.Enumerable.Contains(new ushort[]{0x7b, 0x7e}, (ushort)opcode.Value.Value));

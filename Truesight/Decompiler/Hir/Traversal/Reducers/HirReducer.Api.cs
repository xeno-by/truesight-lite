...
namespace Truesight.Decompiler.Hir.Traversal.Reducers
{
    ...
    public static partial class HirReducer
    {
        ...
        public static T Reduce<TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, T>(this Node e, Func<TIn1, T> reducer1, Func<TIn2, T> reducer2, Func<TIn3, T> reducer3, Func<TIn4, T> reducer4, Func<TIn5, T> reducer5, Func<TIn6, T> reducer6)
            where TIn1 : Node
            where TIn2 : Node
            where TIn3 : Node
            where TIn4 : Node
            ...
            where TIn6 : Node
        {
            ...
            map.Add(typeof(TIn4), new Reducer_Thunk<TIn4, T>(reducer4).Snippet);
            map.Add(typeof(TIn5), new Reducer_Thunk<TIn5, T>(reducer5).Snippet);
            map.Add(typeof(TIn6), new Reducer_Thunk<TIn6, T>(reducer6).Snippet);
            return new LateBoundHirReducer<T>(map).Reduce(e);
        }

        public static T Reduce<TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, TIn7, T>(this Node e, Func<TIn1, T> reducer1, Func<TIn2, T> reducer2, Func<TIn3, T> reducer3, Func<TIn4, T> reducer4, Func<TIn5, T> reducer5, Func<TIn6, T> reducer6, Func<TIn7, T> reducer7)
            where TIn1 : Node
            where TIn2 : Node
            where TIn3 : Node
            where TIn4 : Node
            ...
            where TIn7 : Node
        {
            ...
            map.Add(typeof(TIn5), new Reducer_Thunk<TIn5, T>(reducer5).Snippet);
            map.Add(typeof(TIn6), new Reducer_Thunk<TIn6, T>(reducer6).Snippet);
            map.Add(typeof(TIn7), new Reducer_Thunk<TIn7, T>(reducer7).Snippet);
            return new LateBoundHirReducer<T>(map).Reduce(e);
        }

        public static T Reduce<TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, TIn7, TIn8, T>(this Node e, Func<TIn1, T> reducer1, Func<TIn2, T> reducer2, Func<TIn3, T> reducer3, Func<TIn4, T> reducer4, Func<TIn5, T> reducer5, Func<TIn6, T> reducer6, Func<TIn7, T> reducer7, Func<TIn8, T> reducer8)
            where TIn1 : Node
            where TIn2 : Node
            where TIn3 : Node
            where TIn4 : Node
            ...
            where TIn8 : Node
        {
            ...
            map.Add(typeof(TIn6), new Reducer_Thunk<TIn6, T>(reducer6).Snippet);
            map.Add(typeof(TIn7), new Reducer_Thunk<TIn7, T>(reducer7).Snippet);
            map.Add(typeof(TIn8), new Reducer_Thunk<TIn8, T>(reducer8).Snippet);
            return new LateBoundHirReducer<T>(map).Reduce(e);
        }
